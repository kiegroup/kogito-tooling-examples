...
import { Association, PingPongPageChannelApi, PingPongPageEnvelopeApi, PingPongPageInitArgs } from "../api";
...
export class PingPongPageEnvelopeApiImpl implements PingPongPageEnvelopeApi {
  constructor(
    private readonly args: EnvelopeApiFactoryArgs<
      PingPongPageEnvelopeApi,
      PingPongPageChannelApi,
      PingPongPageViewApi,
  ...
  public async pingPongPage__init(association: Association, initArgs: PingPongPageInitArgs) {
